...
alter table se_media_tag_relation add constraint fk_se_media_tag_relation_medi_16 foreign key (media_id) references se_media (id);
create index ix_se_media_tag_relation_medi_16 on se_media_tag_relation (media_id);
alter table se_media_tag_relation add constraint fk_se_media_tag_relation_tag_17 foreign key (tag_id) references se_tag (id);
create index ix_se_media_tag_relation_tag_17 on se_media_tag_relation (tag_id);
alter table se_media_tag_relation add constraint fk_se_media_tag_relation_crea_18 foreign key (user_id) references se_user (id);
