...
alter table se_tag add constraint fk_se_tag_media_16 foreign key (media_id) references se_media (id) on delete restrict on update restrict;
create index ix_se_tag_media_16 on se_tag (media_id);
alter table se_tag add constraint fk_se_tag_creator_17 foreign key (user_id) references se_user (id) on delete restrict on update restrict;
