...
alter table se_event add constraint fk_se_event_owner_4 foreign key (owner_id) references se_user (id);
create index ix_se_event_owner_4 on se_event (owner_id);
alter table se_event add constraint fk_se_event_root_5 foreign key (root_id) references se_bucket (id);
create index ix_se_event_root_5 on se_event (root_id);
alter table se_image_file_relation add constraint fk_se_image_file_relation_imag_6 foreign key (image_id) references se_image (id);
create index ix_se_image_file_relation_imag_6 on se_image_file_relation (image_id);
alter table se_image_file_relation add constraint fk_se_image_file_relation_file_7 foreign key (file_id) references se_file (id);
create index ix_se_image_file_relation_file_7 on se_image_file_relation (file_id);
alter table se_media add constraint fk_se_media_owner_8 foreign key (owner_id) references se_user (id);
create index ix_se_media_owner_8 on se_media (owner_id);
alter table se_media add constraint fk_se_media_event_9 foreign key (event_id) references se_event (token);
create index ix_se_media_event_9 on se_media (event_id);
alter table se_media add constraint fk_se_media_image_10 foreign key (image_id) references se_image (id);
create index ix_se_media_image_10 on se_media (image_id);
alter table se_media_tag_relation add constraint fk_se_media_tag_relation_medi_11 foreign key (media_id) references se_media (id);
create index ix_se_media_tag_relation_medi_11 on se_media_tag_relation (media_id);
alter table se_media_tag_relation add constraint fk_se_media_tag_relation_tag_12 foreign key (tag_id) references se_tag (id);
create index ix_se_media_tag_relation_tag_12 on se_media_tag_relation (tag_id);
alter table se_media_tag_relation add constraint fk_se_media_tag_relation_crea_13 foreign key (user_id) references se_user (id);
create index ix_se_media_tag_relation_crea_13 on se_media_tag_relation (user_id);
