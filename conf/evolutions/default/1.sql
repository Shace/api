...
alter table se_access_token_event_relation add constraint fk_se_access_token_event_relat_2 foreign key (event_id) references se_event (id) on delete restrict on update restrict;
create index ix_se_access_token_event_relat_2 on se_access_token_event_relation (event_id);
alter table se_access_token_event_relation add constraint fk_se_access_token_event_relat_3 foreign key (accessToken_id) references se_access_token (token) on delete restrict on update restrict;
create index ix_se_access_token_event_relat_3 on se_access_token_event_relation (accessToken_id);
alter table se_bucket add constraint fk_se_bucket_parent_4 foreign key (parent_id) references se_bucket (id) on delete restrict on update restrict;
create index ix_se_bucket_parent_4 on se_bucket (parent_id);
alter table se_bucket add constraint fk_se_bucket_event_5 foreign key (event_id) references se_event (id) on delete restrict on update restrict;
create index ix_se_bucket_event_5 on se_bucket (event_id);
alter table se_comment add constraint fk_se_comment_owner_6 foreign key (owner_id) references se_user (id) on delete restrict on update restrict;
create index ix_se_comment_owner_6 on se_comment (owner_id);
alter table se_comment add constraint fk_se_comment_media_7 foreign key (media_id) references se_media (id) on delete restrict on update restrict;
create index ix_se_comment_media_7 on se_comment (media_id);
alter table se_event add constraint fk_se_event_root_8 foreign key (root_id) references se_bucket (id) on delete restrict on update restrict;
create index ix_se_event_root_8 on se_event (root_id);
alter table se_event_user_relation add constraint fk_se_event_user_relation_even_9 foreign key (event_token) references se_event (id) on delete restrict on update restrict;
create index ix_se_event_user_relation_even_9 on se_event_user_relation (event_token);
alter table se_event_user_relation add constraint fk_se_event_user_relation_use_10 foreign key (user_id) references se_user (id) on delete restrict on update restrict;
create index ix_se_event_user_relation_use_10 on se_event_user_relation (user_id);
alter table se_image_file_relation add constraint fk_se_image_file_relation_ima_11 foreign key (image_id) references se_image (id) on delete restrict on update restrict;
create index ix_se_image_file_relation_ima_11 on se_image_file_relation (image_id);
alter table se_image_file_relation add constraint fk_se_image_file_relation_fil_12 foreign key (file_id) references se_file (id) on delete restrict on update restrict;
create index ix_se_image_file_relation_fil_12 on se_image_file_relation (file_id);
alter table se_media add constraint fk_se_media_owner_13 foreign key (owner_id) references se_user (id) on delete restrict on update restrict;
create index ix_se_media_owner_13 on se_media (owner_id);
alter table se_media add constraint fk_se_media_event_14 foreign key (event_id) references se_event (id) on delete restrict on update restrict;
create index ix_se_media_event_14 on se_media (event_id);
alter table se_media add constraint fk_se_media_image_15 foreign key (image_id) references se_image (id) on delete restrict on update restrict;
create index ix_se_media_image_15 on se_media (image_id);
alter table se_media_tag_relation add constraint fk_se_media_tag_relation_medi_16 foreign key (media_id) references se_media (id) on delete restrict on update restrict;
create index ix_se_media_tag_relation_medi_16 on se_media_tag_relation (media_id);
alter table se_media_tag_relation add constraint fk_se_media_tag_relation_tag_17 foreign key (tag_id) references se_tag (id) on delete restrict on update restrict;
create index ix_se_media_tag_relation_tag_17 on se_media_tag_relation (tag_id);
alter table se_media_tag_relation add constraint fk_se_media_tag_relation_crea_18 foreign key (user_id) references se_user (id) on delete restrict on update restrict;
create index ix_se_media_tag_relation_crea_18 on se_media_tag_relation (user_id);



alter table se_bucket_media add constraint fk_se_bucket_media_se_bucket_01 foreign key (se_bucket_id) references se_bucket (id) on delete restrict on update restrict;

alter table se_bucket_media add constraint fk_se_bucket_media_se_media_02 foreign key (se_media_id) references se_media (id) on delete restrict on update restrict;
...
drop table if exists se_access_token_event_relation;

drop table if exists se_bucket;

drop table if exists se_bucket_media;
