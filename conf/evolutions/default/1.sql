...
alter table se_media add constraint fk_se_media_ownerUser_2 foreign key (owner_user_id) references se_user (id) on delete restrict on update restrict;
create index ix_se_media_ownerUser_2 on se_media (owner_user_id);
alter table se_media add constraint fk_se_media_ownerEvent_3 foreign key (owner_event_id) references se_event (token) on delete restrict on update restrict;
create index ix_se_media_ownerEvent_3 on se_media (owner_event_id);
alter table se_media_tag_relation add constraint fk_se_media_tag_relation_media_4 foreign key (media_id) references se_media (id) on delete restrict on update restrict;
create index ix_se_media_tag_relation_media_4 on se_media_tag_relation (media_id);
alter table se_media_tag_relation add constraint fk_se_media_tag_relation_tag_5 foreign key (tag_id) references se_tag (id) on delete restrict on update restrict;
create index ix_se_media_tag_relation_tag_5 on se_media_tag_relation (tag_id);
alter table se_media_tag_relation add constraint fk_se_media_tag_relation_creat_6 foreign key (user_id) references se_user (id) on delete restrict on update restrict;
